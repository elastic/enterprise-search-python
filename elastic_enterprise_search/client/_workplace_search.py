...
class WorkplaceSearch(BaseClient):
    ...
    def get_auto_query_refinement_details(
        ...
        `<https://www.elastic.co/guide/en/workplace-search/master/workplace-search-content-sources-api.html#get-automatic-query-refinement-details-api>`_
    ...
    def put_content_source_icons(
        ...
        `<https://www.elastic.co/guide/en/workplace-search/master/workplace-search-content-sources-api.html#upload-content-source-icon-api>`_
    ...
    def delete_documents_by_query(
        ...
        `<https://www.elastic.co/guide/en/workplace-search/master/workplace-search-custom-sources-api.html#delete-documents-by-query>`_
